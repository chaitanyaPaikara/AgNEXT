...
echo " Temperature and Humidity is: $DHTTempHumidity"
echo " BMP Pressure and Temperature is: $BMPPressureTemp"

echo "Executing Command for Xbee communication."
command="sudo python /home/pi/weatherStation/zigbee_tx.py $DHTTempHumidity $BMPPressureTemp"
eval $command

echo "Taking Image from Webcam"
webcam="sudo fswebcam image.jpg"
eval $webcam

echo "Sending Image to the Central Node"
img_command="sudo python /home/pi/weatherStation/zigbee_tx_IMG.py"
eval $img_command
